/*
  ...
  - Added the required column `imageColor` to the `Board` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "imageColor" TEXT NOT NULL,
